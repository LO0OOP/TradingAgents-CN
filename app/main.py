...
async def lifespan(app: FastAPI):
    ...
    # The login page advertises this account for first-run Docker deployments.
    # The service is idempotent and leaves an existing admin untouched.
    try:
    ...
    if settings.QUOTES_BACKFILL_ON_STARTUP:
        async def run_startup_quote_backfill() -> None:
            try:
        ...
        asyncio.create_task(run_startup_quote_backfill())
